const pages = [
  {
    content: `
      <div class="gif"><img src="giphy.gif" alt="A beautiful image"></div>
      <p>Hello 👋</p>
  ...
  {
    content: `
      <div class="photo"><img src="giphy.gif" alt="A beautiful image"></div>
  ...
  },
  {
    content: `
      ...
      <div class="photos"><img src="giphy.gif" alt="A beautiful image"
class="photos"><img src="giphy.gif" alt="A beautiful image"
class="photos"><img src="giphy.gif" alt="A beautiful image"
class="photos"><img src="giphy.gif" alt="A beautiful image"></div>
      <div class="navigation">
        <button onclick="prevPage()">Previous</button>
        <button onclick="nextPage()">Next</button>
      </div>
